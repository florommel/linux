...
_raw_spin_lock(raw_spinlock_t *lock) __acquires(lock);
...
void __lockfunc __attribute__((multiverse))
_raw_spin_lock_bh(raw_spinlock_t *lock) __acquires(lock);

void __lockfunc __attribute__((multiverse))
_raw_spin_lock_irq(raw_spinlock_t *lock) __acquires(lock);
...
void __lockfunc __attribute__((multiverse))
_raw_spin_unlock(raw_spinlock_t *lock) __releases(lock);

void __lockfunc __attribute__((multiverse))
_raw_spin_unlock_bh(raw_spinlock_t *lock) __releases(lock);
